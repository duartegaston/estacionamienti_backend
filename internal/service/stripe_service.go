...
func (s *StripeService) CreateCheckoutSession(amount int64, currency, customerEmail string, language string) (string, string, error) {
	params := &stripe.CheckoutSessionParams{
		...
		SuccessURL:    stripe.String("http://front-estacionamiento-octaviomartinduarte-5073s-projects.vercel.app/" + language + "/reservations/create/?session_id={CHECKOUT_SESSION_ID}"),
		CancelURL:     stripe.String("http://front-estacionamiento-octaviomartinduarte-5073s-projects.vercel.app/" + language + "/reservations/create/failed"),
